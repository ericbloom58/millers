...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 04, 2018 at 04:23 AM
...
INSERT INTO `products` (`id`, `name`, `description`, `price`, `category`, `created`) VALUES
(1, 'test', '<p>tester</p>', '100.00', 'meat', '2018-01-04 01:46:01'),
(2, 'test2', '<p>test2</p>', '200.00', 'meat', '2018-01-04 01:48:07'),
(3, 'test3', '<p>test3</p>', '300.00', 'meat', '2018-01-04 01:48:51');
